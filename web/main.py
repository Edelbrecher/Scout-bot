...
async def toggle_role(request: Request, guild_id: str, role_id: str, field: str = Form(...)):
    ...
    if field not in {"allowed_role_ids", "res_manager_role_ids", "private_channel_role_ids", "defend_role_ids", "archive_role_ids", "res_push_view_role_ids"}:
...
_DEFAULT_SIDEBAR_NAV = [
    ...
    {"type": "item",  "icon": "search",    "label": "Player Search",      "url_suffix": "/intel"},
